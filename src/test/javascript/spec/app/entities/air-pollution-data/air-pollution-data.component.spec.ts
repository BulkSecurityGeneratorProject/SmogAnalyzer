...
import { AirPollutionDataComponent } from 'app/entities/air-pollution-data/air-pollution-data.component';
...
describe('Component Tests', () => {
    describe('AirPollutionData Management Component', () => {
        let comp: AirPollutionDataComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(AirPollutionDataComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.airPollutionData[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
